...
piA=[];
 ...
 %gth_1= rgb2gray(imread('cameraman3.jpg'));
...
for i = 2:r+1
    for j = 2:k+1
        ...
        e_a_1= (1- ((A).^b_2).*exp(1- ((A).^b_2)))/9;
        e_b_1= (1- ((t1).^b_2).*exp(1- ((t1).^b_2)))/9;
        e_ab_1 = (1- (((A+t1)/2).^b_2).*exp(1- (((A+t1)/2).^b_2)))/9;
        d1= (e_a_1+e_b_1)/2 - e_ab_1; 
        min1 =min(min(d1));
        
        e_a_2= (1- ((A).^b_2).*exp(1- ((A).^b_2)))/9;
        e_b_2= (1- ((t2).^b_2).*exp(1- ((t2).^b_2)))/9;
        e_ab_2 = (1- (((A+t2)/2).^b_2).*exp(1- (((A+t2)/2).^b_2)))/9;
        d2= (e_a_2+e_b_2)/2 - e_ab_2; 
        min2 =min(min(d2));
        
        e_a_3= (1- ((A).^b_2).*exp(1- ((A).^b_2)))/9;
        e_b_3= (1- ((t3).^b_2).*exp(1- ((t3).^b_2)))/9;
        e_ab_3 = (1- (((A+t3)/2).^b_2).*exp(1- (((A+t3)/2).^b_2)))/9;
        d3= (e_a_3+e_b_3)/2 - e_ab_3; 
        min3 =min(min(d3));
        
        e_a_4= (1- ((A).^b_2).*exp(1- ((A).^b_2)))/9;
        e_b_4= (1- ((t4).^b_2).*exp(1- ((t4).^b_2)))/9;
        e_ab_4 = (1- (((A+t4)/2).^b_2).*exp(1- (((A+t4)/2).^b_2)))/9;
        d4= (e_a_4+e_b_4)/2 - e_ab_4; 
        min4 =min(min(d4));
        
        e_a_5= (1- ((A).^b_2).*exp(1- ((A).^b_2)))/9;
        e_b_5= (1- ((t5).^b_2).*exp(1- ((t5).^b_2)))/9;
        e_ab_5 = (1- (((A+t5)/2).^b_2).*exp(1- (((A+t5)/2).^b_2)))/9;
        d5= (e_a_5+e_b_5)/2 - e_ab_5; 
        min5 =min(min(d5));
        
        e_a_6= (1- ((A).^b_2).*exp(1- ((A).^b_2)))/9;
        e_b_6= (1- ((t6).^b_2).*exp(1- ((t6).^b_2)))/9;
        e_ab_6 = (1- (((A+t6)/2).^b_2).*exp(1- (((A+t6)/2).^b_2)))/9;
        d6= (e_a_6+e_b_6)/2 - e_ab_6; 
        min6 =min(min(d6));
        
        e_a_7= (1- ((A).^b_2).*exp(1- ((A).^b_2)))/9;
        e_b_7= (1- ((t7).^b_2).*exp(1- ((t7).^b_2)))/9;
        e_ab_7 = (1- (((A+t7)/2).^b_2).*exp(1- (((A+t7)/2).^b_2)))/9;
        d7= (e_a_7+e_b_7)/2 - e_ab_7; 
        min7 =min(min(d7));
        
        e_a_8= (1- ((A).^b_2).*exp(1- ((A).^b_2)))/9;
        e_b_8= (1- ((t8).^b_2).*exp(1- ((t8).^b_2)))/9;
        e_ab_8 = (1- (((A+t8)/2).^b_2).*exp(1- (((A+t8)/2).^b_2)))/9;
        d8= (e_a_8+e_b_8)/2 - e_ab_8; 
        min8 =min(min(d8));
        
        e_a_9= (1- ((A).^b_2).*exp(1- ((A).^b_2)))/9;
        e_b_9= (1- ((t9).^b_2).*exp(1- ((t9).^b_2)))/9;
        e_ab_9 = (1- (((A+t9)/2).^b_2).*exp(1- (((A+t9)/2).^b_2)))/9;
        d9= (e_a_9+e_b_9)/2 - e_ab_9; 
        min9 =min(min(d9));
        
        e_a_10= (1- ((A).^b_2).*exp(1- ((A).^b_2)))/9;
        e_b_10= (1- ((t10).^b_2).*exp(1- ((t10).^b_2)))/9;
        e_ab_10 = (1- (((A+t10)/2).^b_2).*exp(1- (((A+t10)/2).^b_2)))/9;
        d10= (e_a_10+e_b_10)/2 - e_ab_10;
        min10 =min(min(d10));
        
        e_a_11= (1- ((A).^b_2).*exp(1- ((A).^b_2)))/9;
        e_b_11= (1- ((t11).^b_2).*exp(1- ((t11).^b_2)))/9;
        e_ab_11 = (1- (((A+t11)/2).^b_2).*exp(1- (((A+t11)/2).^b_2)))/9;
        d11= (e_a_11+e_b_11)/2 - e_ab_11;
        min11 =min(min(d11));
        
        e_a_12= (1- ((A).^b_2).*exp(1- ((A).^b_2)))/9;
        e_b_12= (1- ((t12).^b_2).*exp(1- ((t12).^b_2)))/9;
        e_ab_12 = (1- (((A+t12)/2).^b_2).*exp(1- (((A+t12)/2).^b_2)))/9;
        d12= (e_a_12+e_b_12)/2 - e_ab_12; 
        min12 =min(min(d12));
        
        e_a_13= (1- ((A).^b_2).*exp(1- ((A).^b_2)))/9;
        e_b_13= (1- ((t13).^b_2).*exp(1- ((t13).^b_2)))/9;
        e_ab_13 = (1- (((A+t13)/2).^b_2).*exp(1- (((A+t13)/2).^b_2)))/9;
        d13= (e_a_13+e_b_13)/2 - e_ab_13; 
        min13 =min(min(d13));
        
        e_a_14= (1- ((A).^b_2).*exp(1- ((A).^b_2)))/9;
        e_b_14= (1- ((t14).^b_2).*exp(1- ((t14).^b_2)))/9;
        e_ab_14 = (1- (((A+t14)/2).^b_2).*exp(1- (((A+t14)/2).^b_2)))/9;
        d14= (e_a_14+e_b_14)/2 - e_ab_14;
        min14 =min(min(d14));
        
        e_a_15= (1- ((A).^b_2).*exp(1- ((A).^b_2)))/9;
        e_b_15= (1- ((t15).^b_2).*exp(1- ((t15).^b_2)))/9;
        e_ab_15 = (1- (((A+t15)/2).^b_2).*exp(1- (((A+t15)/2).^b_2)))/9;
        d15= (e_a_15+e_b_15)/2 - e_ab_15; 
        min15 =min(min(d15));
        
        e_a_16= (1- ((A).^b_2).*exp(1- ((A).^b_2)))/9;
        e_b_16= (1- ((t16).^b_2).*exp(1- ((t16).^b_2)))/9;
        e_ab_16 = (1- (((A+t16)/2).^b_2).*exp(1- (((A+t16)/2).^b_2)))/9;
